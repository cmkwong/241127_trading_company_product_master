...
const Sub_FileUploadsHeader = ({
  ...
  return (
    <div
      className={`${styles.headerRow} ${tableCell ? styles.tableCellHeaderRow : ''}`}
    >
      {label && <label className={styles.label}>{label}</label>}
      <div className={styles.headerActions}>
        {showSelectAll && (
          <label
            className={`${styles.selectAllWrap} ${tableCell ? styles.tableCellTool : ''}`}
        ...
        {showToggleSelectButton && (
          <button
            type="button"
            className={`${styles.sequenceEditorIconBtn} ${tableCell ? styles.tableCellTool : ''}`}
        ...
        {tableCell && isImageMode && (
          <span
            className={styles.tableCellImageCounter}
